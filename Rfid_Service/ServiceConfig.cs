...
namespace Rfid_Service
{
    ...
    public class ServiceConfig
    {
        ...
        public class Reader
        {
            ...
            [XmlElement("Location")] public string ReaderName { get; set; }
            ...
            [XmlElement("Port_No")] public int PortNum { get; set; }

            [XmlElement("TimeOut_s")] public int TimeOut { get; set; }

            [XmlElement("OPC_Tags")] public ReaderTags Tags { get; set; }

            public class Uid
            {
                [XmlAttribute("Note")] public string UidNote { get; set; }
            ...
            {
                [XmlElement("ReadTags")] public ReadTags ReaderTag { get; set; }

                [XmlElement("WriteTags", IsNullable = true)]
                public WriteTags WriterTag { get; set; }

                [XmlElement("UidTags")] public UidTags UuidTag { get; set; }

                [XmlElement("ErrorTags")] public ErrorTags ErrorTag { get; set; }

                public class ReadTags
                {
                    [XmlAttribute("Note")] public string Note { get; set; }

                    [XmlElement("ReadTag")] public string ReadTag { get; set; }
                }
                ...
                public class WriteTags
                {
                    ...
                    [XmlElement("WriteTag")] public string WriteTag { get; set; }
                }
                ...
                public class UidTags
                {
                    ...
                    [XmlElement("UUID")] public string UuidTag { get; set; }
                }
                ...
                public class ErrorTags
                {
                    ...
                    [XmlElement("Error_Boolean")] public string ErrorBool { get; set; }

                    [XmlElement("Error_String")] public string ErrorString { get; set; }
                }
            }
        }
        ...
        public class OPC
        {
            [XmlElement("ServerAddress")] public string ServerAddress { get; set; }

            [XmlElement("ServerPort")] public int ServerPort { get; set; }

            [XmlElement("Authorization")] public LogonAuth Auth { get; set; }
